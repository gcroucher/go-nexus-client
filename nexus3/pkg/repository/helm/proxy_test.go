...
func getTestHelmProxyRepository(name string) repository.HelmProxyRepository {
...
func TestHelmProxyRepository(t *testing.T) {
	...
	repo := getTestHelmProxyRepository("test-helm-repo-hosted-" + strconv.Itoa(rand.Intn(1024)))
